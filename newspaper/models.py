...
class TimeStampModel(models.Model): #like a base app that is extended by other class
...
#one post can have many comment => M
#one comment is associated only with single post =>1